...
SETUP_SPEC = ChannelSetupSpec(
    fields={
        ...
        "docCommentEnabled": field("bool", default=False, snapshot=False),
        "docCommentMentionOnly": field("bool", default=True, snapshot=False),
        "docCommentFromUsers": field("list", snapshot=False),
